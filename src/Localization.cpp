...
static const wchar_t* const kStrings[kStrCount][kLangCount] = {
    ...
    { L"Enable hotkey", L"Включить горячую клавишу", L"Activer le raccourci", L"Tastenkombination aktivieren", L"Abilita tasto rapido", L"Habilitar atajo" },
    ...
    { L"Apply", L"Применить", L"Appliquer", L"Übernehmen", L"Applica", L"Aplicar" },
    { L"Test", L"Тест", L"Test", L"Test", L"Test", L"Probar" },
    ...
    { L"Perfect for:", L"Идеально для:", L"Parfait pour:", L"Perfekt für:", L"Perfetto per:", L"Perfecto para:" },
    { L"Long downloads and uploads", L"Длительные загрузки и выгрузки", L"Téléchargements longs", L"Lange Downloads und Uploads", L"Download e upload lunghi", L"Descargas y subidas largas" },
    { L"Presentations and meetings", L"Презентации и встречи", L"Présentations et réunions", L"Präsentationen und Meetings", L"Presentazioni e riunioni", L"Presentaciones y reuniones" },
    { L"Monitoring and automation", L"Мониторинг и автоматизация", L"Surveillance et automatisation", L"Überwachung und Automatisierung", L"Monitoraggio e automazione", L"Monitoreo y automatización" },
    { L"Media playback", L"Воспроизведение медиа", L"Lecture multimédia", L"Medienwiedergabe", L"Riproduzione media", L"Reproducción de medios" },
    { L"Right-click tray icon for settings", L"ПКМ на иконке в трее для настроек", L"Clic droit sur l'icône pour les paramètres", L"Rechtsklick auf Tray-Symbol für Einstellungen", L"Clic destro sull'icona per le impostazioni", L"Clic derecho en el icono para configuración" },
    ...
    { L"Please enter duration between 5 and 1440 minutes.",
      ...
      L"Introduce una duración entre 5 y 1440 minutos." },
    { L"Please select a time in the future.",
      ...
      L"Selecciona una hora en el futuro." },
    { L"Failed to update the autostart setting.",
      ...
      L"No se pudo cambiar el inicio automático." },
    { L"Failed to save settings. Changes may be lost after restart.",
      ...
      L"No se pudieron guardar los ajustes. Los cambios pueden perderse después de reiniciar." },
    ...
    { L"Timer expired. Everon disabled.",
      ...
      L"Temporizador agotado. Everon desactivado." },
    { L"Hotkey registered successfully", L"Горячая клавиша зарегистрирована", L"Raccourci enregistré avec succès", L"Tastenkombination erfolgreich registriert", L"Tasto rapido registrato con successo", L"Atajo registrado correctamente" },
    { L"Failed to register hotkey. It may be in use by another application.",
      ...
      L"No se pudo registrar el atajo. Puede estar en uso por otra aplicación." },
