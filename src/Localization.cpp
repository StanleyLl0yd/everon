...
static const wchar_t* const kStrings[kStrCount][kLangCount] = {
    ...
    { L"Failed to register hotkey. It may be in use by another application.", L"Не удалось зарегистрировать горячую клавишу. Возможно, она используется другим приложением.", L"Échec de l'enregistrement du raccourci. Il peut être utilisé par une autre application.", L"Tastenkombination konnte nicht registriert werden. Sie wird möglicherweise von einer anderen Anwendung verwendet.", L"Impossibile registrare il tasto rapido. Potrebbe essere in uso da un'altra applicazione.", L"No se pudo registrar el atajo. Puede estar en uso por another application." },
